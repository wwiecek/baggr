...
#' For more information on how and why these variables were chosen and standardised, see Meager (2019) or consult the associated code repository which includes the standardisation scripts, which can be found at https://bitbucket.org/rmeager/aggregate-average-impacts-microcredit/src/master/
#'
#' @format A data frame with 40267 rows, 7 study idenfitifiers and 7 outcomes
"microcredit"
#' @references Meager, Rachael (2019) Understanding the average impact of microcredit expansions: A Bayesian hierarchical analysis of seven randomized experiments. American Economic Journal: Applied Economics, 11(1), 57-91.
...
#'  Includes only complete cases and only the consumer durables outcome variable.
#'
...
#' This dataframe contains a column of estimated treatment effects of an SAT prep program implemented in 8 different schools in the US, and a column of estimated standard errors.

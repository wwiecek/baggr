...
test_that("Error messages for wrong inputs are in place", {
  ...
  # wrong column chosen
  expect_error(baggr(microcredit, grouping = "study"), "no column")
  ...
  expect_error(baggr(microcredit, model = "quantiles", quantiles = c(.1, .3, .5, .9),
                     outcome = "profit", grouping = "study"),
               "NA")

...
The current version (v0.4, February 2020) is a stable version of a tool that's in active development so we are counting on your feedback.
...
Try `vignette('baggr')` for an overview of these functions and an example of meta-analysis workflow with `baggr`. If working with binary data, try `vignette("baggr_binary")`.
...
In the coming months (spring-summer 2020) we will be including more models and more features such as:

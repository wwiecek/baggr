...
The current version (v0.3, December 2019) is a stable prototype of a tool that's in active development so we are counting on your feedback.
...
In the coming months (spring 2020) we will be including more models and more features such as:

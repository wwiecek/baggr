...
[![Codecov test coverage](https://codecov.io/gh/wwiecek/baggr/branch/master/graph/badge.svg)](https://codecov.io/gh/wwiecek/baggr?branch=master)
<!-- badges: end -->
...
Before starting, please follow [the installation instructions for RStan](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started), which is responsible for Bayesian inference in _baggr_. If you don't have Stan, it's worth following the instructions step-by-step.
...
Most common issue in installing _baggr_ is with updating other packages. Try updating your packages (and ensure R is at least version 4) before trying the `remotes` command.

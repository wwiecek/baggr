...
Choosing between the three is especially important in the case of rare events, as this will have a potentially large impact on the results. Let us consider three models: 
...
We exagerrate our prior choices on purpose, to best illustrate the differences.
...
bg_rare_prior3 <- baggr(df_rare, effect = "logOR", model = "logit",
                        pooling_control = "partial",
                        chains = 2, iter = 500,
                        prior_control = normal(-4.59, 1), prior_control_sd = normal(0, 2))
bg_rare_prior4 <- baggr(df_rare, effect = "logOR", model = "logit",
                        chains = 2, iter = 500,
...
bgc <- baggr_compare(
  ...
  "Independent N(-4.59, 10^2)" = bg_rare_prior4
)

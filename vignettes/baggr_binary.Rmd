...
#> Hypermean (tau) =  -0.17 with 95% interval -0.62 to 0.25 
#> Hyper-SD (sigma_tau) = 0.2513 with 95% interval 0.0073 to 0.8693 
#> Total pooling (1 - I^2) = 0.83 with 95% interval 0.31 to 1.00 
#> 
#> Treatment effects on logarithm of odds ratio:
#>               mean   sd  2.5%    50% 97.5% pooling
#> Balcon      -0.129 0.27 -0.66 -0.131  0.43    0.76
#> Clausen     -0.154 0.25 -0.67 -0.146  0.34    0.73
#> Multicentre -0.073 0.27 -0.56 -0.091  0.53    0.75
#> Barber      -0.201 0.28 -0.80 -0.187  0.32    0.79
#> Norris      -0.152 0.22 -0.60 -0.152  0.28    0.67
#> Kahler      -0.269 0.35 -1.13 -0.227  0.32    0.88
#> Ledwich     -0.192 0.35 -0.97 -0.172  0.49    0.92
```
...
#> Model 1 -0.616408 -0.171539 0.245398 -0.167049 0.219643
#> Model 2 -0.549238 -0.170723 0.255888 -0.179799 0.197878
#> 
#> SD for treatment effects:
#>               2.5%     mean    97.5%   median       sd
#> Model 1 0.00732784 0.251271 0.869261 0.189670 0.234176
#> Model 2 0.01255340 0.230423 0.815892 0.173687 0.205480
#> 
#> Posterior predictive effects:
#>              2.5%      mean    97.5%    median       sd
#> Model 1 -1.096240 -0.178589 0.598104 -0.166257 0.429815
#> Model 2 -0.811561 -0.152680 0.597076 -0.149268 0.345565
```
...
#> Mean treatment effects:
#>                     2.5%      mean    97.5%    median       sd
#> Correct by .10  -2.38361 -0.663156 1.145630 -0.686197 0.841644
#> Correct by .25  -2.47734 -0.766914 0.866540 -0.736229 0.797601
#> Correct by 1.0  -1.95968 -0.691385 0.484702 -0.682442 0.631515
#> Individual data -2.85052 -0.990628 0.574931 -0.928815 0.830757
#> 
#> SD for treatment effects:
#>                      2.5%     mean   97.5%   median       sd
#> Correct by .10  0.0510918 1.180490 4.05458 0.878713 1.090710
#> Correct by .25  0.0382085 1.016570 3.43991 0.755664 0.924168
#> Correct by 1.0  0.0233703 0.844928 2.90125 0.636213 0.796236
#> Individual data 0.0465336 1.331560 5.46021 0.917737 1.388550
#> 
#> Posterior predictive effects:
#>                     2.5%      mean   97.5%    median      sd
#> Correct by .10  -4.34286 -0.575129 3.74320 -0.596242 1.91805
#> Correct by .25  -3.98362 -0.754431 2.15637 -0.718965 1.46218
#> Correct by 1.0  -3.56204 -0.728547 1.99289 -0.737182 1.36762
#> Individual data -5.55796 -0.976086 3.12347 -0.884666 2.13992
...
#> Mean treatment effects:
#>                                          2.5%      mean    97.5%    median       sd
#> Summary-level (Rubin model on logOR) -2.03071 -0.626539 0.613836 -0.609367 0.653131
#> Individual-level (logistic model)    -2.90184 -0.817531 0.617720 -0.745934 0.822496
#> 
#> SD for treatment effects:
#>                                           2.5%    mean   97.5%   median       sd
#> Summary-level (Rubin model on logOR) 0.0245569 0.83125 3.14548 0.601729 0.824709
#> Individual-level (logistic model)    0.0397210 1.18273 6.86841 0.679902 1.561840
#> 
#> Posterior predictive effects:
#>                                          2.5%      mean   97.5%    median      sd
#> Summary-level (Rubin model on logOR) -3.47467 -0.614814 2.09539 -0.573335 1.35458
#> Individual-level (logistic model)    -4.21039 -0.687989 2.63497 -0.637570 1.78476
plot(bgc2)
```
...
#> Mean treatment effects:
#>                                2.5%      mean    97.5%    median       sd
#> Rubin model                -2.03071 -0.626539 0.613836 -0.609367 0.653131
#> Independent N(0,10^2)      -2.90184 -0.817531 0.617720 -0.745934 0.822496
#> Hierarchical prior         -1.99745 -0.733146 0.383845 -0.715414 0.588060
#> Independent N(-4.59, 10^2) -1.78185 -0.663348 0.576564 -0.681483 0.614445
#> 
#> SD for treatment effects:
#>                                 2.5%     mean   97.5%   median       sd
#> Rubin model                0.0245569 0.831250 3.14548 0.601729 0.824709
#> Independent N(0,10^2)      0.0397210 1.182730 6.86841 0.679902 1.561840
#> Hierarchical prior         0.0193451 0.615662 1.94141 0.508539 0.577890
#> Independent N(-4.59, 10^2) 0.0572526 0.894791 3.11353 0.714641 0.759276
#> 
#> Posterior predictive effects:
#>                                2.5%      mean   97.5%    median      sd
#> Rubin model                -3.38700 -0.612342 2.00584 -0.566367 1.31282
#> Independent N(0,10^2)      -4.88347 -0.731388 3.07576 -0.616124 2.41945
#> Hierarchical prior         -2.84105 -0.719235 1.48264 -0.713638 1.08369
#> Independent N(-4.59, 10^2) -3.35368 -0.742972 2.38737 -0.779822 1.33704
...
#> Mean treatment effects:
#>                                  2.5%      mean    97.5%    median       sd
#> No covariate                -0.616408 -0.171539 0.245398 -0.167049 0.219643
#> With covariates, 0-1 coding -0.985707 -0.335936 0.250279 -0.332638 0.313067
#> 
#> SD for treatment effects:
#>                                   2.5%     mean    97.5%  median       sd
#> No covariate                0.00732784 0.251271 0.869261 0.18967 0.234176
#> With covariates, 0-1 coding 0.00830993 0.281869 0.991986 0.20941 0.264365
#> 
#> Posterior predictive effects:
#>                                 2.5%      mean    97.5%    median       sd
#> No covariate                -1.05050 -0.170425 0.653566 -0.157853 0.413332
#> With covariates, 0-1 coding -1.35231 -0.342865 0.588221 -0.328496 0.484197
#> 
#> Mean (SD) for covariates:
#>         model      study_grouping
#>  No covariate 0.338573 (0.428444)
```
...
#> 
#> Aggregate treatment effect (on logarithm of odds ratio):
#> Hypermean (tau) =  -0.34 with 95% interval -0.99 to 0.25 
#> Hyper-SD (sigma_tau) = 0.2819 with 95% interval 0.0083 to 0.9920 
#> Total pooling (1 - I^2) = 0.80 with 95% interval 0.26 to 1.00 
#> 
#> Treatment effects on logarithm of odds ratio:
#>                mean   sd  2.5%     50% 97.5% pooling
#> Balcon      -0.0052 0.29 -0.59 -0.0069  0.57    0.73
#> Clausen     -0.0312 0.29 -0.65 -0.0282  0.55    0.70
#> Multicentre  0.0601 0.30 -0.52  0.0555  0.69    0.72
#> Barber      -0.3417 0.32 -0.98 -0.3457  0.28    0.76
#> Norris      -0.2626 0.27 -0.77 -0.2704  0.27    0.64
#> Kahler      -0.4188 0.40 -1.30 -0.3925  0.31    0.86
#> Ledwich     -0.3397 0.40 -1.21 -0.3332  0.44    0.90
#> 
